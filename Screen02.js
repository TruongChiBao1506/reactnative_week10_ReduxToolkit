    ...
    return (
        <View style={Styles.container}>
            <View style={Styles.Part1}>
                ...
                <TouchableOpacity style = {{width:120, height:40, borderRadius:5, backgroundColor:'#33CCFF', justifyContent:'center', alignItems:'center'}} onPress={()=>navigation.navigate('Screen04')}>
                    <Text style = {{fontSize:12, fontWeight:700, color:'white'}}>Thêm sản phẩm</Text>
                </TouchableOpacity>
